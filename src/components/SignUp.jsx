...
export default function Signup() {
  ...
  function handleSubmit(event){
		...
		// constructor fx built into browser
		// all fields must have "name" prop set
    ...
    // 'confirm-password' includes a - so requires [] notation
    if (data.password !== data['confirm-password']){
      setPasswordsAreNotEqual(true)
      return; // don't execute any further code in fx
    }
